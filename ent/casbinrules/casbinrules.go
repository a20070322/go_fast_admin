...
const (
	// Label holds the string label denoting the casbinrules type in the database.
	Label = "casbin_rules"
	...
	FieldV5 = "v5"
	// Table holds the table name of the casbinrules in the database.
	Table = "casbin_rules"
)

// Columns holds all SQL columns for casbinrules fields.
var Columns = []string{
	FieldID,
	FieldPtype,
	FieldV0,
